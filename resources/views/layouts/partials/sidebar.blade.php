            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item
                    ...
                    <ul class="nav nav-treeview">
                      ...
                      <li class="nav-item">
                        <a href="{{ route('admin.charts') }}" class="nav-link {{ request()->is('admin/charts') ? 'active' : '' }}">
                          <i class="far fa-circle nav-icon"></i>
                          <p>Charts</p>
                        </a>
                      </li>
                      <li class="nav-item">
                        <a href="{{ route('admin.ielement') }}" class="nav-link {{ request()->is('admin/ielement') ? 'active' : '' }}">
                          <i class="far fa-circle nav-icon"></i>
                          <p>UI Elements</p>
                        </a>
                      </li>
                      <li class="nav-item">
                        <a href="{{ route('admin.forms') }}" class="nav-link {{ request()->is('admin/forms') ? 'active' : '' }}">
                          <i class="far fa-circle nav-icon"></i>
                          <p>Forms</p>
                        </a>
                      </li>
                      <li class="nav-item">
                        <a href="{{ route('admin.tables') }}" class="nav-link {{ request()->is('admin/tables') ? 'active' : '' }}">
                          <i class="far fa-circle nav-icon"></i>
                          <p> Tables</p>
                        </a>
                      </li>
