            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">User About</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    </section>
    <section class="content life-mr1">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-3">
                                ...
                                <div class="active tab-pane" id="activity">
                                    ...
                                    <div class="post">
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-sm-6">
                                                <img class="img-fluid"
                                                    src="{{ asset('dashboard/dist/img/photo1.png') }}" alt="Photo">
                                            </div>
                                            <!-- /.col -->
                                            <div class="col-sm-6">
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <img class="img-fluid mb-3"
                                                            src="{{ asset('dashboard/dist/img/photo2.png') }}"
                                                            alt="Photo">
                                                        <img class="img-fluid"
                                                            src="{{ asset('dashboard/dist/img/photo3.jpg') }}"
                                                            alt="Photo">
                                                    </div>
                                                    <!-- /.col -->
                                                    <div class="col-sm-6">
                                                        <img class="img-fluid mb-3"
                                                            src="{{ asset('dashboard/dist/img/photo4.jpg') }}"
                                                            alt="Photo">
                                                        <img class="img-fluid"
                                                            src="{{ asset('dashboard/dist/img/photo1.png') }}"
                                                            alt="Photo">
                                                    </div>
                                                    <!-- /.col -->
                                                </div>
